...
#define NICKNAME "GWANGJU06_LEEYOUNGDO"
...
int main()
{
	...
	while (1)
	{
		...
		if (cnt == 4) {  // stage4에 2번째 공을 위한 코드1
			radian = atan(width / height);
			angle = (float)(((180 / M_PI) * radian) + 212.5);
		} 
		...
		// stage4에 2번째 공을 위한 코드2
		if(cnt == 4) power = (float)distance * 0.2f;
